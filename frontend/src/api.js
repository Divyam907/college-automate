...
export const markAttendance = (photo, sectionId, periodId, force = false) =>
  api.post('/api/teacher/mark-attendance', { photo, section_id: sectionId, period_id: periodId, force })
...
export const captureLiveness = (sectionId, photo) =>
  api.post('/api/teacher/liveness/capture', { section_id: sectionId, photo })
